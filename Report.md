...
- **Kadin**: I initially created all the feature branches for the team. I implemented the game_board branch, opened its pull request, and also reviewed the ghost branch. Finally, my branch was merged after review.
